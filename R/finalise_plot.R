...
#' Arrange alignment and save Peter Mac ggplot chart
#'
#' Running this function will save your plot with the correct guidelines for publication for a Peter Mac graphic.
