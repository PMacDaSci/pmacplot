...
This shows how to create a stream graph using base R, such as the one in [Figure 1B Solomon et al, 2020](https://www.sciencedirect.com/science/article/pii/S1556086420300277#fig1). The graph shows the allele frequencies of a founder fusion mutation and G810 substitution mutations that emerged over time.
